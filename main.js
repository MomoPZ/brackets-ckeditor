...
define(function (require, exports, module) {
	 ...
	 * @param {type} indent    Indent for in ckeditor edited content     
	 */
	function _loadCk (hostEditor, content, range, indent) {
    ...
    function bracketsCkeditor() {
        ...
        var range,
            ...
            indent = hostEditor.document.getRange( { line: sel.start.line, ch: 0 }, { line: sel.start.line, ch: sel.start.ch } );
        ...
        if (sel.start.line === sel.end.line && sel.start.ch === sel.end.ch) {
			...
			if(rangeStart.line && rangeEnd.line) {
				...
				indent = hostEditor.document.getRange( { line: rangeStart.line, ch: 0 }, rangeStart );
